        ...
        LazyColumn(
            ...
            item {
                ...
                Button(
                    onClick = {
                        when {
                            (name.isEmpty() || phoneNo.isEmpty() || email.isEmpty() || password.isEmpty() || confirmPassword.isEmpty()) -> {
                                errorMessage = context.getString(R.string.error_fill_all_detail)
                            }

                            (password != confirmPassword) -> {
                                errorMessage = context.getString(R.string.error_password_mismatched)
                            }

                            (prefManager.checkAlreadyExist(email)) -> {
                                errorMessage = context.getString(R.string.error_user_already_exist)
                            }
