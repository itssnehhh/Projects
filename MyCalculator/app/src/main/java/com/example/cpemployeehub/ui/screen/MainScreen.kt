...
import com.example.cpemployeehub.constatnt.Constant.EMPLOYEE_LIST_SCREEN
import com.example.cpemployeehub.constatnt.Constant.HOME_SCREEN
import com.example.cpemployeehub.constatnt.Constant.NOTIFICATION_SCREEN
import com.example.cpemployeehub.constatnt.Constant.PROFILE_SCREEN
...
fun NavHostContainer(navController: NavHostController, paddingValues: PaddingValues) {
    ...
    NavHost(
        ...
        composable(EMPLOYEE_LIST_SCREEN) {
            ...
            val viewModel: EmpViewModel = viewModel(
                factory = EmpViewModelFactory(
                    EmployeeRepository(
                        EmployeeDatabase.getDatabase(LocalContext.current).employeeDao()
                    )
                )
            )
